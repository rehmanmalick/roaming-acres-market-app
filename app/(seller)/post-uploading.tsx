          ...
          <View className="flex-1">
            ...
            <View className="bg-white py-6 rounded-lg">
              ...
              <View className="flex-row items-center mb-4">
                ...
                <Text className="ml-2">Add product detailed</Text>
              </View>
              <TextInput
                className="border border-gray-300 rounded-lg p-4 h-32 mb-4"
              ...
              <TouchableOpacity
                className="flex-row items-center justify-center border border-gray-300 rounded-lg h-32 mb-4"
                onPress={pickImage}
              >
                {selectedImage ? (
                  <Image
