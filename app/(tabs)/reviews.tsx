...
import { View, Text, ScrollView, TextInput, TouchableOpacity, Image, KeyboardAvoidingView } from 'react-native';
    ...
    >
      <Wrapper showBackButton={true}>
        ...
        <View className="bg-white p-6 rounded-lg">
          ...
          <Text className="text-4xl font-bold text-center mb-4">What do you think?</Text>
            ...
            {[1, 2, 3, 4, 5].map((star) => (
              ...
              >
                <Ionicons
                  ...
                  size={32}
                  color={star <= (hoverRating || rating) ? '#FFD700' : '#CCCCCC'}
                />
              </TouchableOpacity>
            ))}
          </View>
          ...
          <View className="flex-row items-center mt-4">
              <Button title='CANCEL' onPress={()=> router.push('/(tabs)/home-screen')} state='secondary'/>
          <Button 
            title="SUBMIT REVIEW"
