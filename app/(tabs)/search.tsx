...
import { View, Text,Image, ScrollView, TextInput, TouchableOpacity, Touchable } from 'react-native';
        ...
        {categories.map((category, index) => (
            ...
            <View className="px-2">
              <View className="flex-row justify-between">
                ...
                <ShopByCategory iconState='secondary' text='Poultry Name' price={2060} source={require('../../assets/images/egg-tray.png')} />
              </View>
              <View className="flex-row justify-between">
                <ShopByCategory text='Poultry Name' price={2060}/>
                <ShopByCategory iconState='secondary' text='Poultry Name' price={2060} source={require('../../assets/images/egg-tray.png')} />
