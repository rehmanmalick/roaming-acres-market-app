          ...
          <View className="bg-white rounded-lg p-6">
            ...
            <View className="flex-row items-center mb-6">
              <TouchableOpacity onPress={() => setShowCancelModal(false)}>
                ...
                <Ionicons name="chevron-back-outline" size={24} color="#363A33" />
                <Text className="text-lg font-bold text-[#363A33]">Back</Text>
                </View>
              </TouchableOpacity>
              <View className="flex-1 items-center ">

              <Text className="text-2xl font-bold text-center text-[#008080] mr-8">Cancel Order</Text>
              </View>
            </View>
            
            <Text className="text-3xl font-bold text-[#363A33] mb-2">We are sorry to hear this</Text>
            <Text className=" text-gray-600 mb-6">
              Tell us why you choose to cancel your order, is the reason from our side?
            </Text>
            
            <Text className="text-gray-600 mb-2">Write down your reason to cancel your order:</Text>
            <TextInput
