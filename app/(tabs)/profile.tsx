...
export default function EditProfile() {
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
        <View style={styles.container} className="flex-1 bg-[#FDFDFD] items-center">
            <ImageBackground source={require('../../assets/images/profilebg.png')} style={styles.imageBackground} resizeMode="cover">
            ...
            <View className="w-[85%]">
                ...
                <Text className="text-lg text-gray-800 mb-1 mt-4">Phone Number</Text>
                <TextInput
                    className="bg-white py-4 px-4 rounded-lg border border-teal-600"
                    value={phone}
