...
export default function OrderPlaced() {
  ...
  return (
    <>
      ...
      >
        <Wrapper>
          <View className="items-center mt-9 text-center">
            <Image
          ...
          />
          <View className="flex mt-8 flex-row justify-between items-center ">
          ...
          <View className="flex flex-row mb-2 py-4 justify-between items-center ">
            <View className="flex flex-row items-center">
