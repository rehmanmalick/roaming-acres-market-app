        ...
        >
            ...
            <View className="flex-row justify-between items-center">
              ...
              <View className="flex-row absolute right-0 top-0 ">
                <TouchableOpacity
                  onPress={() =>
                    router.push({
                      pathname: "/(buyer)/(home)/buyer-orders",
          ...
          <View className="mt-6 ">
            <View className="flex-row justify-between items-center pb-3">
              ...
              <TouchableOpacity
                onPress={() => router.push("/(buyer)/(home)/categories")}
                className="bg-white "
              >
          ...
          <View className="mt-6 ">
            <View className="flex-row justify-between items-center pb-3">
              ...
              <TouchableOpacity
                onPress={() => router.push("/(buyer)/(home)/new-arrivals")}
                className="bg-white"
              >
                <Text className="text-primary text-[#8B8B8B]">See All</Text>
              </TouchableOpacity>
          ...
          <View className="mt-6 ">
            <View className="flex-row justify-between items-center pb-3">
              ...
              <TouchableOpacity
                onPress={() => router.push("/(buyer)/(home)/top-sellers")}
                className="bg-white "
              >
                <Text className="text-primary text-[#8B8B8B]">See All</Text>
              </TouchableOpacity>
          ...
          <View className="mt-6 ">
            <View className="flex-row justify-between items-center pb-3">
              ...
              <TouchableOpacity
                onPress={() =>
                  router.push("/(buyer)/(home)/top-selling-products")
                }
                className="bg-white "
              >
                <Text className="text-primary text-[#8B8B8B]">See All</Text>
