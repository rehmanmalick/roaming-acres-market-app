      ...
      >
        <Wrapper showBackButton={true}>
          <View className="mb-16">
            <Text className="text-[25px] text-center font-bold  mt-4">
              Our Categories
            </Text>
            <Text className="text-[18px]  font-bold  mt-9">Livestock</Text>
            <View className="flex flex-row justify-between items-center mt-4 ">
              ...
              >
                <ShopCategory
                  ...
                  text="Cattle"
                  onPress={() =>
                    router.push("/(buyer)/(home)/inner-categories")
                  }
                />
                <ShopCategory
            ...
            <Text className="text-[18px]  font-bold  mt-9">Poultry</Text>
            <View className="flex flex-row justify-between items-center mt-4 ">
              <ScrollView
                horizontal
                showsHorizontalScrollIndicator={false}
            ...
            <Text className="text-[18px]  font-bold  mt-9">Other Animals</Text>
            <View className="flex flex-row justify-between items-center mt-4 ">
              <ScrollView
                horizontal
                showsHorizontalScrollIndicator={false}
            ...
            <Text className="text-[18px]  font-bold  mt-9">
              Homegrown Produce
            </Text>
            <View className="flex flex-row justify-between items-center mt-4 ">
              <ScrollView
            ...
            <Text className="text-[18px]  font-bold  mt-9">Eggs and Dairy</Text>
            <View className="flex flex-row justify-between items-center mt-4 ">
              <ScrollView
                horizontal
                showsHorizontalScrollIndicator={false}
