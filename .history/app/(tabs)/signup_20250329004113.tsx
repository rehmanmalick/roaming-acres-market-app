...
const SignupScreen = () => {
  ...
  const isFormValid = () => formData.fullName && isEmailValid() && isPasswordValid();
  ...
  return (
    <View className="flex-1 bg-white px-6 justify-center">
      {/* Title */}
      <Text className="text-3xl font-bold text-center text-gray-800 mb-8">Create Account</Text>
      ...
      {/* Sign Up Button */}
      <TouchableOpacity
        className={`w-full py-4 rounded-lg ${isFormValid() ? "bg-blue-600" : "bg-blue-400"} flex items-center justify-center`}
