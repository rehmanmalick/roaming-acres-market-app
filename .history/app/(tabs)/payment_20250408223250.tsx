    ...
    >
      <Wrapper showBackButton={true}>
            ...
            {paymentMethods.map((method) => (
              <TouchableOpacity
                ...
                className={`items-center justify-center p-4 mx-2 rounded-lg  ${
                  selectedMethod === method.id ? 'border border-teal-600' : 'border-gray-200'
                }`}
                ...
                <View className="relative">
                  ...
                  {selectedMethod === method.id && (
                    <Ionicons 
                      ...
                      size={20} 
                      color="#008080" 
                      style={{ position: 'absolute', top: -17, right: -17, zIndex: 10 }} 
                    />
                  )}
                </View>
                <Text className="text-base font-medium text-center">{method.name}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
            ...
            <View className="flex flex-row items-center">
                <View className="flex flex-row justify-between items-center mx-4 my-4">
                    <Image
                        ...
                        className='w-16 h-10 mb-2'
                    />
          <Text className="text-lg font-semibold ml-3">**** **** **** 436</Text>
          </View>
                </View>
            </View>
        ...
        <TouchableOpacity 
            ...
            onPress={() => router.push('Rounded button pressed')}
        >
