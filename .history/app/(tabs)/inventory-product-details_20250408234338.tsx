...
import { View, Text,Image, ScrollView, TextInput, TouchableOpacity, Touchable, StyleSheet } from 'react-native';
        ...
        >
          ...
          >
           ...
           <View className="items-center justify-center mt-9">
            ...
            <View className="flex flex-row items-center border-b border-gray-300 mx-9 pb-6">
                ...
                <View className="flex flex-row items-center">
                    <TouchableOpacity
                        ...
                        disabled={quantity === 1}
                    >
                        <Ionicons name="remove" size={16} color={quantity === 1 ? "#ccc" : "#333"} />
                    </TouchableOpacity>
         ...
         <View className="border-b border-gray-300 mx-9 pb-6" >
               ...
               <Text>porem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</Text>
           </View>
