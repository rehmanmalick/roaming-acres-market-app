...
<View className="mt-6">
  ...
  {/* Dotted line - positioned absolutely */}
  <View style={{
    position: 'absolute',
    left: 11, // Half of icon size (24/2) + some adjustment
    top: 24, // Height of first row
    height: 24, // Space between icons
    borderLeftWidth: 1,
    borderStyle: 'dotted',
    borderColor: 'gray',
  }} />
      ...
      <Text className="text-sm font-semibold text-gray-700">
        Home - 123 Main St, Apt 48
            ...
            <View className="mt-6">
              ...
              <View className="flex-row justify-between border-b border-[#F1F2F3] mb-1 py-4">
