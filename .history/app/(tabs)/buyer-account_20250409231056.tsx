      ...
      >
        <View className="flex-1 justify-center items-center bg-black/50">
          <View className="bg-white rounded-lg p-5 w-4/5">
            <Text className="text-lg font-bold mb-4 text-center">Confirm Logout</Text>
            <Text className="text-gray-600 mb-6 text-center">Are you sure you want to logout?</Text>
