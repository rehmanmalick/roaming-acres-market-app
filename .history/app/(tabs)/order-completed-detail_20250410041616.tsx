...
export default function OrderDetails() {
  return (
    <ScrollView className="flex-1 bg-white p-4">
      ...
      <View className="mt-6 space-y-4">
        <View className="flex-row items-start gap-2">
          ...
          <View>
            ...
            <Text className="text-sm text-gray-700">Roaming Acres Market</Text>
          </View>
        </View>
        ...
        <View className="flex-row items-start gap-2">
          ...
          <View>
            ...
            <Text className="text-sm text-gray-700">Home - 123 Main St, Apt 48</Text>
          </View>
        </View>
      </View>
      ...
      {/* Invoice Section */}
      <View className="mt-6">
        <Text className="text-base font-semibold mb-2">Invoice Details</Text>
      ...
      <TouchableOpacity className="mt-6 bg-black py-3 rounded-lg flex-row items-center justify-center">
        ...
        <Text className="text-white ml-2 font-medium">Download Invoice</Text>
      </TouchableOpacity>
    </ScrollView>
  );
}
