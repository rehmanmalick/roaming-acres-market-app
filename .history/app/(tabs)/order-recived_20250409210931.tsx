...
export default function OrderRecieved() {
  ...
  return (
    ...
    <Wrapper showBackButton={true} showPeriodButton={true}>
        ...
        <Text className="text-6xl text-center my-9 font-bold mx-9 text-gray-600">Your order has been placed.</Text>
        <CheckoutComponent 
        ...
        />
        <View className="mt-9">
            <Button state="primary" title="Order Confirmed!" onPress={()=> router.push('/reviews')}/>
        </View>
    </Wrapper>
      </ScrollView>
    </>
