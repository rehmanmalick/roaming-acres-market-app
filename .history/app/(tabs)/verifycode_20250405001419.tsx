...
const VerificationSuccessScreen = () => {
  ...
  return (
    <Wrapper>
      <View className="flex-1 w-full bg-white px-6 justify-around items-center">
        <View>
          {/* Success Image */}
          <Images            source={require("../../assets/images/congratulation.png")} // Replace with your image path
