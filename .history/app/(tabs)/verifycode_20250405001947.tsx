  ...
  return (
    <Wrapper>
      <View className="flex-1 w-full bg-white px-6 justify-center items-center">
        <View className="w-full bg-white px-6 justify-between items-center">
          <View>
            {/* Success Image */}
            <Image
          ...
          {/* Continue Button */}
          <TouchableOpacity
            className={`w-full py-4 rounded-[3px] bg-[${COLORS.primary}] flex items-center justify-center mt-10`}
