...
const LoginScreen = () => {
  ...
  const isFormValid = () => isEmailValid(formData.email) && isPasswordValid(formData.password);
  ...
  return (
    ...
    <View className="flex-1 bg-white px-6 justify-center">
      ...
      <TouchableOpacity className="self-end mb-6" onPress={() => router.push("/resetpassword")}>
