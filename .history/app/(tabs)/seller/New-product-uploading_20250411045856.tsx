      ...
      <Wrapper>
        <View className="px-3">
          ...
          <View className="flex-row items-center mb-4">
            ...
            />
            <View>
              <Text className="text-lg font-bold">Your Store</Text>
            ...
            {selectedImage ? (
              ...
              <>
                <Ionicons
                  ...
                  color="#3b82f6"
                />
                <Text className="text-blue-500 mt-2">Upload Product Image</Text>
              </>
            )}
          </Pressable>
          ...
          <View className="flex-row justify-between mb-8">
            <Pressable className="bg-blue-600 px-6 py-3 rounded-md flex-1 mr-2">
