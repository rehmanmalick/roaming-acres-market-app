                    ...
                    <View className="mt-8 px-3">
                        ...
                        <View className="bg-teal-600 px-4 py-7 my-4 rounded-xl">
                            <View className="flex flex-row justify-between mb-6">
                                <View>
                                    <Text className="text-yellow-300 text-md font-semibold mb-2">0.0</Text>
                                    <Text className="text-white text-md font-semibold">Completed Orders</Text>
                                </View>
                                <View>
                                    <Text className="text-yellow-300 text-md font-semibold mb-2">0.0</Text>
                                    <Text className="text-white text-md font-semibold">Completed Orders</Text>
                        ...
                        <View className="flex-row items-center justify-between space-x-4">
                            <View className="px-2">
                                <View className="bg-teal-600 items-center justify-center py-7 px-9 rounded-md">
                            ...
                            <View className="px-2">
                                <View className="bg-orange-500 items-center justify-center py-7 px-9 rounded-md">
                                    <Text className="text-white text-3xl">0</Text>
                                </View>
                                <View>
                            ...
                            <View className="px-2">
                                <View className="bg-yellow-300 items-center justify-center py-7 px-9 rounded-md">
                                    <Text className="text-white text-3xl">0</Text>
                                </View>
                                <View>
                            ...
                            <View className="px-2">
                                <View className="bg-black items-center justify-center py-7 px-9 rounded-md">
                                    <Text className="text-white text-3xl">0</Text>
                                </View>
                                <View>
                                    <Text className="text-center mt-2">Cancel</Text>
                                </View>
                            </View>
                        </View>
                        <View className="mt-8 px-3">
                        ...
                        <View className="flex flex-row ">
                            <Button state="secondary" title="ADD TO CART" showIcon={true} iconName={'plus'} />
                            <Button state="secondary" title="BULK UPLOAD" showIcon={true} iconName={'plus'} />
                        </View>
                        <View className="py-4">
                        ...
                        <View className="mt-4 px-3">
                            <View className="flex-row justify-between items-center pb-3">
                                ...
                                <TouchableOpacity
                                    className="bg-white py-1 px-3"
                                >
                                    <Text className="text-primary text-[#8B8B8B]">View Details</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View className="flex flex-row px-3 py-2 justify-between">
                            <View>
                                <Text className="mb-1 font-semibold text-lg">Total Earning</Text>
                                <Text className="text-teal-600 font-bold text-xl">$200</Text>
                                <Text className="mb-1 font-semibold text-lg mt-3">Avg. Selling Price</Text>
                                <Text className="text-teal-600 font-bold text-xl">$87.55</Text>
                                <Text className="mb-1 font-semibold text-lg mt-3">Pending Clearance</Text>
                                <Text className="text-teal-600 font-bold text-xl">$350.66</Text>
                            </View>
                            <View>
                                <Text className="mb-1 font-semibold text-lg">Earning in January</Text>
                                <Text className="text-teal-600 font-bold text-xl">$500</Text>
                                <Text className="mb-1 font-semibold text-lg mt-3">Active Orders</Text>
                                <Text className="text-teal-600 font-bold text-xl">05</Text>
                                <Text className="mb-1 font-semibold text-lg mt-3">Cancelled Orders</Text>
