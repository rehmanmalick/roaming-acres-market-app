...
export default function ProductUploadScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-white p-4">
      <Text className="text-xl font-bold text-center mb-4">Add New Product</Text>

      <Pressable onPress={pickImage} className="border-2 border-dashed border-gray-300 rounded-xl h-48 items-center justify-center bg-gray-50 mb-4">
        {image ? (
      ...
      <View className="flex-row justify-between">
        <Pressable className="flex-1 mr-2 bg-green-500 py-3 rounded-lg">
          <Text className="text-white font-bold text-center">UPLOAD PRODUCT</Text>
        </Pressable>
