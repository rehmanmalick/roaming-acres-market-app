...
const SellerHomeScreen = () => {
    ...
    <>
      ...
      >
        <Wrapper showFilterButton={true} showMenuButton={true}>
          <ProfileHeader account="Seller" route="/(tabs)/seller/seller-account" />
  ...
  routetab2="/seller/favorites" 
  routetab3="/seller/items"
  routetab4="/seller/orders"
  routetab5="/seller/conversations"
/>
    </>
  );
};
