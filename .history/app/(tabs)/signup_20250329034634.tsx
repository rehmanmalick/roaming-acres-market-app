  ...
  return (
    <Wrapper>
      <View className="flex-1 w-full bg-white px-6 justify-start mt-8">
        ...
        {/* Sign Up Button */}
        <TouchableOpacity
          className={`w-full  py-4 rounded-[3px]  ${
        ...
        <View className="flex-row justify-center mt-6">
          <Text className="text-[#111719]">Already have an account? </Text>
          <TouchableOpacity onPress={() => router.push("/login")}>
            <Text className="text-[#008080] underline underline-[#008080] font-semibold">Login</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Wrapper>
