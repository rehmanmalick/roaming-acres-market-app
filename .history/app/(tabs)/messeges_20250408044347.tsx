...
import Entypo from "@expo/vector-icons/Entypo"; // Import Entypo
  ...
  return (
    <Wrapper>
      <View className="flex-1 bg-white">
        {/* Header */}
        <View className="flex-row items-center p-3 border-b border-gray-200 mt-[-30]">
          <Image
            source={
              currentUser === "1"
          ...
          {/* Back Button with Entypo icon */}
          <TouchableOpacity onPress={() => router.back()}>
            <Entypo name="arrow-left" size={24} color="#FF7622" /> {/* Using Entypo arrow-left */}
          </TouchableOpacity>
        </View>
