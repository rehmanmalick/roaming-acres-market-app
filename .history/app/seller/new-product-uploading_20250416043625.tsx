        ...
        <View className="px-3 py-8">
          ...
          {activeTab === "Add New Product" && (
            <>
              ...
              {/* Category (using custom Dropdown component) */}
              <Dropdown
                label="Category"
              ...
              <View className="flex-row justify-between mb-6">
                <View className="w-[48%]">
                  ...
                  <View className="w-full h-14 border rounded-[3px] px-4 text-base  flex-row  border-gray-300 rounded-md overflow-hidden items-center">
                    <Pressable
