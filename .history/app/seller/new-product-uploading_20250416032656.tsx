        ...
        <View className="px-3 py-8">
          ...
          {activeTab === "Add New Product" && (
            <>
              ...
              <Pressable
                onPress={pickImage}
                className="border-2 border-teal-600 rounded-lg h-40 justify-center items-center mb-4"
              >
                {selectedImage ? (
                  <Image
                  ...
                  <>
                    <Image
                      source={require("../../assets/images/cashback.png")} // use correct path or uri
                      style={{ width: 24, height: 24 }}
                      resizeMode="contain"
                    />
                    <Text className="text-teal-600 mt-2">
