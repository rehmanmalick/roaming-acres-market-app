          ...
          {["Inventory", "Add Inv"].map((status, index) => (
            ...
            >
              <View className="flex items-center w-full">
                <Text
                  className={`flex flex-row items-center justify-center font-bold text-xl rounded-md px-10 py-4 w-full ${
                    activeTab === status
                      ? "text-white bg-[#008080] border-2 border-[#008080]"
                      : "text-[#008080] border-2 border-[#008080]"
                  }`}
                >
                  {status}
                  <Ionicons
