        ...
        <View className="px-3 py-8">
          ...
          {activeTab === "Add New Product" && (
            <>
              ...
              />
              {/* Price and Sales Price Dropdowns */}
              <View className="flex-row justify-between mb-4">
                <View className="w-[48%]">
                  <Dropdown
                    label="Price"
                    options={["$10", "$20", "$30", "$40", "$50"]} // Example options, you can adjust as needed
                    selectedValue={price}
                ...
                <View className="w-[48%]">
                  <Dropdown
                    label="Sales Price"
                    options={["$5", "$10", "$15", "$20", "$25"]} // Example options, adjust as needed
                    selectedValue={salesPrice}
                    onValueChange={(value) => setSalesPrice(value)}
                    focusedBorderColor="#008080"
                    defaultBorderColor="#ccc"
                  />
                </View>
