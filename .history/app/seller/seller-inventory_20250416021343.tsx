  ...
  return (
    ...
    >
      <Wrapper showFilterButton={true} showMenuButton={true}>
        ...
        import {router} from "expo-router"; // Inside your component:
        <View className="flex-row justify-center items-center space-x-4">
          {["Inventory", "Add Inv"].map((status, index) => (
            <TouchableOpacity
              ...
              onPress={() => {
                if (status === "Add Inv") {
                  router.push("/add-inventory"); // change this to your actual route
                } else {
                  setActiveTab(status);
                }
              }}
            ...
            >
              <View
                className={`flex-row items-center justify-center rounded-md px-10 py-4 w-full ${
                  activeTab === status
