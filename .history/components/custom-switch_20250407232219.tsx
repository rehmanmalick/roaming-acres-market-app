...
const CustomSwitch: React.FC<CustomSwitchProps> = ({
  ...
  const backgroundColor = animation.interpolate({
    inputRange: [0, 1],
    outputRange: ["import React, { useEffect, useRef, useState } from "react";
import { View, Pressable, Animated } from "react-native";
...
const CustomSwitch: React.FC<CustomSwitchProps> = ({
  ...
  const backgroundColor = animation.interpolate({
    inputRange: [0, 1],
    outputRange: ['#d1d1d1', '#00796b'], // Grey to teal when toggled on
  });
...
", "#00796b"], // Grey to teal when toggled on
  });
