...
const OrderComponent = ({ name, price, source, subText, onPress , buttonText}: TopSellersComponentProps) => {
  return (
    ...
    <View className="w-24 h-24 rounded-lg justify-center items-center mr-3 bg-white overflow-hidden">
      ...
      <View className="flex-1 pl-6">
        ...
        <TouchableOpacity 
          ...
          onPress={onPress}
        >
          <Text style={{backgroundColor:"#008080" , padding:10 , borderRadius:5}} className="text-white text-sm font-bold px-6">{buttonText}</Text>
        </TouchableOpacity>
    </View>
  );
};
