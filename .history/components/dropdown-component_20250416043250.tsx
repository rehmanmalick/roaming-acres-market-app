  ...
  return (
    <View className="mb-4 ">
      ...
      <TouchableOpacity
        ...
        className="w-full h-14 border rounded-[3px] px-4 text-base rounded-lg p-3 flex-row justify-between items-center"
        onPress={() => {
      ...
      {expanded && (
        <View className="mt-1 border border-t-0 border-gray-300 rounded-b-lg mt-[-1px] bg-white">
          {options.map((item) => (
            <TouchableOpacity
              key={item}
