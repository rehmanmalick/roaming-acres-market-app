...
const Dropdown: React.FC<DropdownProps> = ({
  ...
  const [isFocused, setIsFocused] = useState(false); // Manage focused state separately
  ...
  const handleFocus = () => {
    setIsFocused(true); // Set focus when tapped
  };

  const handleBlur = () => {
    setIsFocused(false); // Set blur when the dropdown loses focus
  };
  ...
  return (
    <View className="mb-4">
      ...
      <TouchableOpacity
        ...
        onFocus={handleFocus} // Focus when the dropdown is focused
      >
