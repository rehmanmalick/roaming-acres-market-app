...
const OrderSummary: React.FC<OrderSummaryProps> = ({ order, productDetails }) => {
    ...
    <View className="p-4 bg-white rounded-lg shadow-md mb-3">
      ...
      {isExpanded && (
        <View className="mt-3 pt-3 border-t border-gray-100">
          ...
          {order.note && (
            <View className="mt-2">
              <Text className="font-medium text-gray-800 mb-1">Note:</Text>
              <Text className="text-sm text-gray-600">{order.note}</Text>
            </View>
          )}
        </View>
      )}
