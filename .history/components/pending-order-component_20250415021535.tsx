...
const PendingOrder: React.FC<PendingOrderProps> = ({
  ...
  const statusStyle = status === "Pending" ? "#F8E473" : "#F08080"; // Pending is yellow, Cancelled is red
  ...
  return (
    ...
    >
      <View className="flex flex-row justify-between pl-3">
        ...
        <View
          className={`bg-[${statusStyle}] px-2 py-1 rounded text-sm font-bold mb-2`}
        >
          <Text className="font-bold text-sm">{statusText}</Text>
        </View>
      </View>
