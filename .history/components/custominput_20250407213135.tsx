  ...
  (
    {
      ...
      errorMessage = "",
      className, // No default value here
      ...props
    },
    ref
  ) => {
    ...
    // Use className if provided, otherwise use the default containerClassName
    const containerClass = className || `mb-4 ${containerClassName}`;
