...
export default function WishlistComponent({
  ...
  return (
    // <View style={{ width: 160 }} className=" rounded-lg shadow-md bg-white  ">
      ...
      <View className="p-3">
        ...
        {showButton && (
          <TouchableOpacity
            onPress={onPress}
            className="bg-teal-600 py-2 px-2 rounded-md justify-evenly items-center mb-2 flex-row"
          >
            <View className="bg-white  p-2 rounded-[100%]">
              <FontAwesome5 name={iconName} size={14} color="#008080" />
            </View>
            <Text className="text-white text-center  text-[14px] font-medium">
              {buttonText}
            </Text>
          </TouchableOpacity>
        )}
