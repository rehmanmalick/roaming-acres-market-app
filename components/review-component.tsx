...
// Replace lucide-react-native Star with Expo's vector icons
  ...
  return (
    <View>
      ...
      <View className="flex-row items-start justify-between ">
        ...
        <Text className="text-[#008080] mt-2 alignItems-start text-sm font-medium">
          {daysAgo} Day{daysAgo === 1 ? "" : "s"} ago
        </Text>
      </View>

      {/* Review text */}
      <View className="border border-gray-300 p-3 mt-4 rounded-md">
